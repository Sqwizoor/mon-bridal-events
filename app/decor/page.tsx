...
const DECOR_CATEGORIES = [
  { value: "all", label: "All Decor", icon: "💎", image: "https://images.unsplash.com/photo-1519741497674-611481863552?w=400&q=80" },
  { value: "candle_holders", label: "Candle Holders", icon: "🕯️", image: "https://images.unsplash.com/photo-1602661856755-6b5894b917c3?w=400&q=80" },
  { value: "vases", label: "Vases", icon: "🏺", image: "https://images.unsplash.com/photo-1582236873550-983196f7c469?w=400&q=80" },
  { value: "table_linen", label: "Table Linen", icon: "🧵", image: "https://images.unsplash.com/photo-1588528998634-9276229ae352?w=400&q=80" },
  { value: "underplates", label: "Underplates", icon: "🍽️", image: "https://images.unsplash.com/photo-1591123120675-6f7f4a542bdf?w=400&q=80" },
  { value: "crockery", label: "Crockery", icon: "🫖", image: "https://images.unsplash.com/photo-1603195867160-c4819779df5e?w=400&q=80" },
  { value: "cutlery", label: "Cutlery", icon: "🍴", image: "https://images.unsplash.com/photo-1616428453472-e4277de14d4e?w=400&q=80" },
  { value: "glassware", label: "Glassware", icon: "🥂", image: "https://images.unsplash.com/photo-1563816999742-5e60d3dce316?w=400&q=80" },
  { value: "cake_stands", label: "Cake Stands", icon: "🎂", image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&q=80" },
  { value: "lanterns", label: "Lanterns", icon: "🏮", image: "https://images.unsplash.com/photo-1583098555848-154df6746815?w=400&q=80" },
  { value: "furniture", label: "Furniture", icon: "🪑", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80" },
  { value: "easels", label: "Easels", icon: "🖼️", image: "https://images.unsplash.com/photo-1456086272160-b28b3a8b423d?w=400&q=80" },
  { value: "candy_jars", label: "Candy Jars", icon: "🍬", image: "https://images.unsplash.com/photo-1602410313174-8898b31a5460?w=400&q=80" },
  { value: "chalkboards", label: "Chalkboards", icon: "📝", image: "https://images.unsplash.com/photo-1541853683-16781224d06a?w=400&q=80" },
  { value: "gift_holders", label: "Gift Holders", icon: "🎁", image: "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=400&q=80" },
  { value: "lawn_games", label: "Lawn Games", icon: "🎯", image: "https://images.unsplash.com/photo-1611080356770-98b4c05b1c55?w=400&q=80" },
  { value: "pots_buckets", label: "Pots & Buckets", icon: "🪴", image: "https://images.unsplash.com/photo-1584949514757-794d21ee6f88?w=400&q=80" },
  { value: "table_decor", label: "Table Decor", icon: "✨", image: "https://images.unsplash.com/photo-1530018352490-64e228d7d80a?w=400&q=80" },
  { value: "miscellaneous", label: "Miscellaneous", icon: "📦", image: "https://images.unsplash.com/photo-1473187983305-f615310e7daa?w=400&q=80" },
];
