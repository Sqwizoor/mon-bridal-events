...
const DECOR_CATEGORIES = [
  { value: "all", label: "All Decor", icon: "💎", image: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=400&q=80" },
  { value: "candle_holders", label: "Candle Holders", icon: "🕯️", image: "https://images.unsplash.com/photo-1603208754228-550f22f710fd?w=400&q=80" },
  { value: "vases", label: "Vases", icon: "🏺", image: "https://images.unsplash.com/photo-1581539250439-c9230243f651?w=400&q=80" },
  { value: "table_linen", label: "Table Linen", icon: "🧵", image: "https://images.unsplash.com/photo-1588528998634-9276229ae352?w=400&q=80" },
  { value: "underplates", label: "Underplates", icon: "🍽️", image: "https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?w=400&q=80" },
  { value: "crockery", label: "Crockery", icon: "🫖", image: "https://images.unsplash.com/photo-1580251147820-205167f402f0?w=400&q=80" },
  { value: "cutlery", label: "Cutlery", icon: "🍴", image: "https://images.unsplash.com/photo-1598209279122-8541213a0383?w=400&q=80" },
  { value: "glassware", label: "Glassware", icon: "🥂", image: "https://images.unsplash.com/photo-1563816999742-5e60d3dce316?w=400&q=80" },
  { value: "cake_stands", label: "Cake Stands", icon: "🎂", image: "https://images.unsplash.com/photo-1620614051023-28c0cc43325e?w=400&q=80" },
  { value: "lanterns", label: "Lanterns", icon: "🏮", image: "https://images.unsplash.com/photo-1542456388-752119eb453e?w=400&q=80" },
  { value: "furniture", label: "Furniture", icon: "🪑", image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=400&q=80" },
  { value: "easels", label: "Easels", icon: "🖼️", image: "https://images.unsplash.com/photo-1513511874987-a2f2b3e8e2fa?w=400&q=80" },
  { value: "candy_jars", label: "Candy Jars", icon: "🍬", image: "https://images.unsplash.com/photo-1616031024329-843815b3c400?w=400&q=80" },
  { value: "chalkboards", label: "Chalkboards", icon: "📝", image: "https://images.unsplash.com/photo-1550953110-38437f8f9c2d?w=400&q=80" },
  { value: "gift_holders", label: "Gift Holders", icon: "🎁", image: "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=400&q=80" },
  { value: "lawn_games", label: "Lawn Games", icon: "🎯", image: "https://images.unsplash.com/photo-1533230983637-25915dcc404b?w=400&q=80" },
  { value: "pots_buckets", label: "Pots & Buckets", icon: "🪴", image: "https://images.unsplash.com/photo-1592634358641-a1e1b8b0e8b2?w=400&q=80" },
  { value: "table_decor", label: "Table Decor", icon: "✨", image: "https://images.unsplash.com/photo-1478146896981-b80fe463b330?w=400&q=80" },
  { value: "miscellaneous", label: "Miscellaneous", icon: "📦", image: "https://images.unsplash.com/photo-1498955472675-532cba97cc18?w=400&q=80" },
];
