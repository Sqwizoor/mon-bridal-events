      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex gap-4 md:gap-8 overflow-x-auto pb-2 scrollbar-none snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0">
          {categories.map((cat, index) => (
            ...
            >
              <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-full p-[2px] bg-gradient-to-tr from-amber-200 via-yellow-400 to-amber-600 bg-[length:400%_400%] animate-gradient-xy group-hover:scale-110 transition-transform duration-300">
